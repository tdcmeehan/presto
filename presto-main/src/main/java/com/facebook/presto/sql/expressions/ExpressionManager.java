        ...
        implements RowExpressionSerde
{
    ...
    @Inject
    public ExpressionManager(InternalNodeManager nodeManager, FunctionAndTypeManager functionAndTypeManager, NodeInfo nodeInfo, JsonCodec<RowExpression> codec)
    {
