...
/**
 * Response wrapper for dynamic filter fetching from workers.
 *
 * <p>Contains the filters as a map from filterId to TupleDomain&lt;String&gt;
 * (using column names), plus the version number for incremental fetching.
 *
 * <p>This class provides proper Jackson annotations for JSON serialization,
 * which allows it to be used with JsonCodec for HTTP transport.
 */
