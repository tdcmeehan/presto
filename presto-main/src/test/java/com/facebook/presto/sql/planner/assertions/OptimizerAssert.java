    ...
    private List<PlanOptimizer> getMinimalOptimizers()
    {
        ...
        return ImmutableList.of(
                ...
                new IterativeOptimizer(
                        ...
                        new SimplifyRowExpressions(metadata, new ExpressionManager(new InMemoryNodeManager(), queryRunner.getFunctionAndTypeManager(), new NodeInfo("test"), jsonCodec(RowExpression.class))).rules()));
    }
