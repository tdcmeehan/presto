...
public class TestDelegatingRowExpressionOptimizer
{
    ...
    public void setUp()
    {
        ...
        ExpressionManager expressionManager = new ExpressionManager(inMemoryNodeManager, METADATA.getFunctionAndTypeManager(), new NodeInfo("env"), JsonCodec.jsonCodec(RowExpression.class));
