...
public class TestSimplifyRowExpressions
{
    ...
    private static void assertSimplifies(String expression, String rowExpressionExpected)
    {
        try {
            ...
            ExpressionManager expressionManager = new ExpressionManager(nodeManager, METADATA.getFunctionAndTypeManager(), new NodeInfo("test"), jsonCodec(RowExpression.class));
