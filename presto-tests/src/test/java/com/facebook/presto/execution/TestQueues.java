...
public class TestQueues
{
            ...
            throws Exception
    {
        try (DistributedQueryRunner queryRunner = createQueryRunner()) {
            ...
            ((InternalResourceGroupManager) queryRunner.getCoordinator().getResourceGroupManager().get()).setConfigurationManager("file", ImmutableMap.of("resource-groups.config-file", getResourceFilePath("resource_groups_config_dashboard.json")));
            ...
            throws Exception
    {
        try (DistributedQueryRunner queryRunner = createQueryRunner()) {
            queryRunner.installPlugin(new ResourceGroupManagerPlugin());
            ((InternalResourceGroupManager) queryRunner.getCoordinator().getResourceGroupManager().get()).setConfigurationManager("file", ImmutableMap.of("resource-groups.config-file", getResourceFilePath("resource_groups_config_soft_limits.json")));
